...
namespace TweenCore.Runtime
{
    ...
    {
        [SerializeField] public UnityEvent<TweenProperty<TweenValueType>> unityOnStart;
        [SerializeField] public UnityEvent<TweenProperty<TweenValueType>> unityOnUpdate;
        [SerializeField] public UnityEvent<TweenProperty<TweenValueType>, TweenValueType> unityOnUpdateValue;
        [SerializeField] public UnityEvent<TweenProperty<TweenValueType>> unityOnFinish;
    }

    [SerializeField] private TweenPropertyUnityEvents _unityEvents = new TweenPropertyUnityEvents();

    public event Action<TweenProperty<TweenValueType>, TweenValueType> OnUpdateValue;
    ...
    public TweenProperty(TweenValueType startVal, TweenValueType finalVal, float time)
    {
    ...
    public TweenProperty(Action<TweenValueType> function, TweenValueType startVal, TweenValueType finalVal, float duration)
    {
    ...
    /// <param name="finalVal">The end value.</param>
    /// <param name="duration">The duration.</param>
    public TweenProperty(UnityEngine.Object obj, string method, TweenValueType finalVal, float duration)
    {
    ...
    /// <param name="finalVal">The end value.</param>
    /// <param name="duration">The duration.</param>
    public TweenProperty(UnityEngine.Object obj, string method, TweenValueType startVal, TweenValueType finalVal, float duration)
    {
        _currentMethod = MethodUse.Reflexion;
    ...
    {
        if (newType == TweenType.Custom || newType == TweenType.CustomCurve)
        {
    ...
    public TweenProperty<TweenValueType> SetType(TweenType newType, Func<float, float> customType)
    {
        if (newType != TweenType.Custom)
        {
            SetType(newType);
            return this;
        }
    ...
    public TweenProperty<TweenValueType> SetType(TweenType newType, AnimationCurve animationCurve)
    {
        if (newType != TweenType.CustomCurve)
        {
            SetType(newType);
            return this;
        }

        type = TweenType.CustomCurve;
    ...
    /// <param name="animationCurve">The animation curve to use as type.</param>
    /// <returns>This TweenProperty to chain the methods calls (e.g. property.SetCustomEase(...).SetEase(...);).</returns>
    public TweenProperty<TweenValueType> SetType(AnimationCurve animationCurve)
    {
        type = TweenType.CustomCurve;
        typeAnimationCurve = animationCurve;
        return this;
    ...
    {
        if (newEase == TweenEase.Custom || newEase == TweenEase.CustomCurve)
        {
    ...
    public TweenProperty<TweenValueType> SetEase(TweenEase newEase, Func<float, Func<float, float>, float> customEase)
    {
        if (newEase != TweenEase.Custom)
        {
            SetEase(newEase);
            return this;
        }
    ...
    /// <returns>This TweenProperty to chain the methods calls (e.g. property.SetCustomEase(...).SetType(...);).</returns>
    public TweenProperty<TweenValueType> SetEase(TweenEase newEase, AnimationCurve animationCurve)
    {
        if (newEase != TweenEase.CustomCurve)
        {
            SetEase(newEase);
            return this;
        }

        ease = TweenEase.CustomCurve;
    ...
    /// <param name="animationCurve">The animation curve to use as ease.</param>
    /// <returns>This TweenProperty to chain the methods calls (e.g. property.SetCustomEase(...).SetType(...);).</returns>
    public TweenProperty<TweenValueType> SetEase(AnimationCurve animationCurve)
    {
        ease = TweenEase.CustomCurve;
        easeAnimationCurve = animationCurve;
        return this;
    ...
    public TweenProperty<TweenValueType> SetIsAdditive(bool isAdd)
    {
